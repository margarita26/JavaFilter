...
public class ImageModelImpl implements ImageModel {
  ...
  /**
   * his is the current image being worked on represented as a 3-D array. Once an image is loaded or
   * passed in as constructor, the 3-D array will be a copy of the currentImage specs, so no
   * overwriting happens.
   */
