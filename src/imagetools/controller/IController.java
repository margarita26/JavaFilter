...
/**
 * This interface represents a imagetools.controller for picture filtering and generation. the
 * controller must be able to either start functionality based on a current view object (GUI), or
 * will only process a text file with batch commands.
 */
